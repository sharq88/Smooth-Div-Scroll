...
(function ($) {
  ...
  $.widget("thomaskahn.smoothDivScroll", {
		...
		_create: function () {
			...
			*****************************************/
			el.data("scrollableArea").mousewheel(function (event, delta, deltaY, deltaY) {
				...
				if (el.data("enabled") && o.mousewheelScrolling.length > 0) {
					...
					if (o.mousewheelScrolling === "vertical" && deltaY !== 0) {
						...
						self.move(pixels);
					} else if (o.mousewheelScrolling === "horizontal" && deltaY !== 0) {
						// Stop any ongoing auto scrolling if it's running
						self.stopAutoScrolling();
						event.preventDefault();
						pixels = Math.round((o.mousewheelScrollingStep * deltaY) * -1);
		...
		getFlickrContent: function (content, manipulationMethod) {
			...
			$.getJSON(content, function (data) {
				...
				function addImageToLoadedImages(imageObj) {
					...
					var heightScalingFactor = el.data("scrollableAreaHeight") / imageObj.height;
					...
					// Set the height of the image to the height of the scrollable area and add the height
					$(imageObj).css({ "height": el.data("scrollableAreaHeight"), "height": tempHeight });
